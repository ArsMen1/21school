...
<img src="Part 1 img/docker pull.png" alt="docker pull" />

 - [docker-run-vs-pull ](https://stackoverflow.com/questions/55941881/docker-run-vs-pull )
...
<img src="Part 1 img/docker run.png" alt="docker run" />

 - [docker run ](https://docs.docker.com/engine/reference/commandline/run/)<br>
 - [docker start ](https://docs.docker.com/engine/reference/commandline/start/)

    run vs Start
    docker run - создает новый контейнер (-d -> в фоновом режиме)
...
<img src="Part 1 img/container size, list of mapped ports and container ip.png" alt="container size, list of mapped ports and container ip" />

 - [docker-containers-ip-address ](https://stackoverflow.com/questions/17157721/how-to-get-a-docker-containers-ip-address-from-the-host)
<hr>

##### Остановить докер образ через `docker stop [container_id|container_name]`
##### Проверить, что образ остановился через `docker ps`

<img src="Part 1 img/docker stop.png" alt="docker stop" />
...
<img src="Part 1 img/curl 80 443.png" alt="curl 80 443" />

 - [curl 80 443](https://ru.hexlet.io/blog/posts/mapping-docker)
<hr>

##### Перезапустить докер контейнер через `docker restart [container_id|container_name]`
##### Проверить любым способом, что контейнер запустился

<img src="Part 1 img/docker restart.png" alt="docker restart" />
<hr>
...
<img src="Part 2 img/nginx conf.png" alt="nginx conf" />

 - [nginx conf](https://nginx.org/ru/docs/beginners_guide.html#conf_structure )
<hr>
...
<img src="Part 2 img/My nginx conf.png" alt="My nginx conf" />

 - [stub_status](https://nginx.org/ru/docs/http/ngx_http_stub_status_module.html#stub_status)
...
<img src="Part 2 img/docker export.png" alt="docker export" />
...
<img src="Part 2 img/docker rmi.png" alt="docker rmi" />
<img src="Part 2 img/docker rm.png" alt="docker rm" />
...
<img src="Part 2 img/docker import.png" alt="docker import" />

 - [docker import](https://docs.docker.com/engine/reference/commandline/import/)
 - [nginx -g 'daemon off:' 1 ](https://stackoverflow.com/questions/18861300/how-to-run-nginx-within-a-docker-container-without-halting)
<hr>
...
##### Запустить написанный мини сервер через *spawn-fcgi* на порту 8080
 ...
 - [docker import](https://youtu.be/WBzCg-mywWQ?t=492)

##### Написать свой *nginx.conf*, который будет проксировать все запросы с 81 порта на *127.0.0.1:8080*
##### Проверить, что в браузере по *localhost:81* отдается написанная вами страничка

<img src="server/Mini web server.png" alt="Mini web server" />
